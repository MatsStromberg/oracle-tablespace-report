...
<tr>
	...
	<td align="center" valign="top" width="100"><a href="otr_db_host.cfm" class="otrtip" title="<div align='center'>DB Instances and<br />the physical location...<br />The report lists the location<br />as of last <cfoutput>#LCased(Dayofweekasstring(Application.snapshot_day))#</cfoutput></div>" onfocus="this.blur();">DB Hosts</a></td>
