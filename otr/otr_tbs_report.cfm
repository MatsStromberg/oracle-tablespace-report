...
<!---
	...
	2013.04.12	mst	Changed Date format in Report Header to be
					MM.DD.YYYY instead of MM.DD.YY
	2013.04.19	mst	Handling No Records listed.
--->
...
<cftry>
	...
	<cfif qReport.RecordCount IS 0><cfset bNoRecords = 1 /></cfif>
...
<cfif bNoRecords IS 0>
	...
	<cfset qNFSreportRecordCount = qNFSreport.RecordCount />
	...
	<tr>
		<td colspan="7">&nbsp;</td>
	</tr><cfset qASMreportRecordCount = qASMreport.RecordCount />
	...
	<tr>
		...
		<td colspan="3">&nbsp;</td>
	</tr><cfif qNFSreportRecordCount GT 0>
	<tr>
		<td colspan="7">&nbsp;</td>
	</tr>
	<tr>
		...
		<td colspan="2">&nbsp;</td>
	</tr></cfif><cfif qASMreportRecordCount GT 0>
	<tr>
...
<cfelse>
	...
	<tr>
		<td width="100%" style="color: red; font-size: 13pt;font-weight: bold; text-align: center;">No Records Found!</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
